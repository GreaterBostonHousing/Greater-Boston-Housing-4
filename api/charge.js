...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const leaseHtml = `<div style="background:#f9f9f9;border:2px solid #C8944A;border-radius:8px;padding:20px;margin:20px 0"><h2 style="color:#C8944A;margin-top:0">SIGNED LEASE AGREEMENT</h2><p><b>Date Signed:</b> ${new Date().toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}</p><p><b>Tenant:</b> ${name} | <b>Email:</b> ${email} | <b>Phone:</b> ${phone||"N/A"}</p><p><b>Property:</b> 20 Hadley Pl, Medford, MA 02155 (Upstairs Apartment)</p><p><b>Room:</b> ${room} — ${bed}</p><p><b>Check-in:</b> ${checkIn} at 3:00 PM | <b>Check-out:</b> ${checkOut} at 11:00 AM</p><p><b>Paid Today:</b> $${Number(amount).toLocaleString()} | <b>Total Est:</b> $${Number(totalEst||0).toLocaleString()}</p><hr style="border:1px solid #ddd;margin:12px 0"/><p><b>1. USE:</b> Residential only. Common areas shared.</p><p><b>2. RENT:</b> $1,400/month due 1st. Failure to pay by the 5th forfeits right to property. $50 late fee applies.</p><p><b>3. CHECK-IN/OUT:</b> Check-in 3:00 PM. Check-out 11:00 AM.</p><p><b>4. ENTRY:</b> Upstairs apartment at 20 Hadley Pl. Enter via front door or upstairs back door.</p><p><b>5. RULES:</b> No smoking. No pets without approval. Quiet hours 10pm-8am. Must wash own dishes. Keep shared spaces clean.</p><p><b>6. UTILITIES:</b> Electric, heat, water, WiFi (TMobile-A500) included.</p><p><b>7. DEPOSIT:</b> $700 at signing. Returned at end of stay barring damages.</p><p><b>8. ACCESS CODES:</b> Outside door code + private room code provided. Must not be shared.</p><p><b>9. CHECK-IN SMS:</b> Codes + WiFi sent by text at 8 AM on check-in date.</p><p><b>10. TERMINATION:</b> 30 days written notice. Failure to pay by 5th = grounds for immediate removal.</p><p><b>11. LANDLORD ACCESS:</b> Landlord may enter with 24-hour notice.</p><hr style="border:1px solid #ddd;margin:12px 0"/><p style="color:green;font-weight:bold">✅ Digitally signed by ${name} on ${new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})} at time of payment.</p><p style="font-size:12px;color:#888">Payment ID: ${paymentIntent.id}</p></div>`;
